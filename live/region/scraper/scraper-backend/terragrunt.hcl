...
inputs = {
  ...
  backend_ami_ssm_architecture_on_demand = local.environment_vars.locals.backend_ami_ssm_architecture_on_demand
  ...
  backend_ami_ssm_architecture_spot      = local.environment_vars.locals.backend_ami_ssm_architecture_spot
