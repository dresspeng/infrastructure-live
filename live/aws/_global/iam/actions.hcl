locals {
  # IAM
  iam_vars                  = read_terragrunt_config("${get_terragrunt_dir()}/actions/iam.hcl")
  ...
  # ECR Private
  ecr_vars                  = read_terragrunt_config("${get_terragrunt_dir()}/actions/ecr.hcl")
  ...
  # ECR Public
  ecr_public_vars                  = read_terragrunt_config("${get_terragrunt_dir()}/actions/ecr-public.hcl")
  ...
  # S3
  s3_vars                  = read_terragrunt_config("${get_terragrunt_dir()}/actions/s3.hcl")
  ...
  # Route53
  route53_vars                  = read_terragrunt_config("${get_terragrunt_dir()}/actions/route53.hcl")
  ...
  # ACM
  acm_vars                  = read_terragrunt_config("${get_terragrunt_dir()}/actions/acm.hcl")
